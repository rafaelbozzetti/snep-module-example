...
class TocaAudioDiscaTroncoAction extends PBX_Rule_Action {
    ...
    public function getName() {
        return $this->i18n->translate("Discar para Tronco e toca audio ao atender");
    }
    ...
    public function setConfig($config) {
        ...
        $config['announce'] = (isset($config['announce'])) ? $config['announce'] : "";
        $this->config = $config;
    }
    ...
    public function getConfig() {
        ...
        $announce        = (isset($this->config['announce']))?"<value>{$this->config['announce']}</value>":"";
...
<params>
    ...
    <audio>
        <id>announce</id>
        <label>{$i18n->translate("Pedido de sinal de Fax")}</label>
        <size>50</size>
        $announce
    </audio>
</params>
